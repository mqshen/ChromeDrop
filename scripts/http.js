  ...
  readRequestFromSocket_: function(pSocket) {
    ...
    var onDataRead = function(data) {
      ...
      if (endIndex == -1) {
        ...
        return pSocket.read().then(onDataRead).catch(function(e) {
          pSocket.close();
        });
      }
    ...
    pSocket.read().then(onDataRead).catch(function(e) {
      console.log("socket read error.", e)
      pSocket.close();
    });
  },
...
WebSocketRequest.prototype = {
  ...
  accept: function(peerId) {
    ...
    responseHeader['Set-Cookie'] = 'peerid=' + peerId + "; SameSite=Strict; Secure";
...
WebSocketServerSocket.prototype = {
  ...
  readFromSocket_: function() {
    ...
    var onDataRead = function(dataBuffer) {
      ...
      return t.pSocket_.read().then(onDataRead).catch(function(e) {
        t.close_();
      });
    };
