...
class ServerConnection {
    ...
    _connect() {
        ...
        ws.onopen = e => console.log('WS: server connected', e);
    ...
    _endpoint() {
        ...
        // return url;
        const webrtc = window.isRtcSupported ? '/webrtc' : '/fallback';
        return 'ws://' + this.address + ':' + this.port + '/server' + webrtc;
    }
...
class RTCPeer extends Peer {
    ...
    constructor(serverConnection, peerId) {
        console.log("rtc peer construct")
    ...
    _onIceConnectionStateChange() {
        console.log("_onIceConnectionStateChange")
...
class PeersManager {
    ...
    _onPeerJoin(event) {
        let peer = event.detail      
        this.joinPeer(peer)
    }

    joinPeer(peer) {
        if (this._server.id && peer.id == this._server.id)
            return;
